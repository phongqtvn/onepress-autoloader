...
namespace Onepress\wpcore;

/**
 * Class Autoloader
 * @package Onepress\wpcore
 * @author oneweb
 * @link https://onepress.net/
 */
class Autoloader
{
    ...
    */
    ...
    {
        $cache = get_site_option('wpcore_autoloader');
    ...
    private function updateCache()
    {
        ...
        update_site_option('wpcore_autoloader', $this->cache);
    }
